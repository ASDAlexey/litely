const translations = {
  en: {
    ...
    'perf.desc': 'Just 5.4 MB. Launches instantly, works fast, takes up almost nothing.',
  ...
  ru: {
    ...
    'perf.desc': 'Всего 5,4 МБ. Мгновенный запуск, быстрая работа, почти не занимает места.',
