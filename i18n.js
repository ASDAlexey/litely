const translations = {
  en: {
    ...
    'jira.title': 'Compress. Upload. Done.',
    'jira.desc':
      'Compress a screenshot or video, switch to the browser — Litely detects which Jira task is open and uploads the file as an attachment. Zero clicks.',
    'jira.f1': 'Auto-upload on window switch — just Alt+Tab to Jira',
    'jira.f2': 'Detects Chrome, Arc, Brave, Safari, Firefox, Edge',
    'jira.f3': 'Generates Jira markup: !image! for images, [^video] for videos',
    'jira.f4': 'Connect multiple Jira instances with per-account toggle',
    'jira.f5': 'Chrome extension for instant paste into comments',
  ...
  ru: {
    ...
    'jira.title': 'Сжал. Загрузил. Готово.',
    'jira.desc':
      'Сожми скриншот или видео, переключись в браузер — Litely определит открытую задачу Jira и загрузит файл как вложение. Ноль кликов.',
    'jira.f1': 'Автозагрузка при переключении окна — просто Alt+Tab в Jira',
    'jira.f2': 'Определяет Chrome, Arc, Brave, Safari, Firefox, Edge',
    'jira.f3': 'Генерирует Jira-разметку: !image! для картинок, [^video] для видео',
    'jira.f4': 'Подключение нескольких Jira с переключателем для каждого',
    'jira.f5': 'Chrome-расширение для мгновенной вставки в комментарии',
