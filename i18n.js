const translations = {
  en: {
    ...
    'jira.desc':
      'Litely detects which Jira task you have open in the browser and uploads compressed files as attachments — automatically.',
    'jira.f1': 'Auto-upload compressed files to Jira tasks',
    'jira.f2': 'Connect multiple Jira instances',
    'jira.f3': 'Smart browser detection — finds active Jira task',
    'jira.f4': 'Generates Jira markup and copies to clipboard',
    'jira.autoupload': 'Auto-upload',
  ...
  ru: {
    ...
    'jira.desc':
      'Litely определяет, какая задача Jira открыта в браузере, и загружает сжатые файлы как вложения — автоматически.',
    'jira.f1': 'Автозагрузка сжатых файлов в задачи Jira',
    'jira.f2': 'Подключение нескольких инстансов Jira',
    'jira.f3': 'Умное определение браузера — находит активную задачу',
    'jira.f4': 'Генерирует Jira-разметку и копирует в буфер обмена',
    'jira.autoupload': 'Авто-загрузка',
    'jira.accounts': 'АККАУНТЫ',
    'jira.connected': 'Подключено',
    'jira.add': '+ Добавить Jira',
